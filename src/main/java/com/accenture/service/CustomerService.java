...
public interface CustomerService {
    ...
    CustomerResponseDto partiallyUpdateCustomer(int idCustomer, CustomerRequestDto customerRequestDto);
    void deleteCustomer(int idCustomer) throws ConnectedUserException;
}
